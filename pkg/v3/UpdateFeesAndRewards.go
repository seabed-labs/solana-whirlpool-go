...
func (inst *UpdateFeesAndRewards) GetUpdateFeesAndRewardsAccounts() *UpdateFeesAndRewardsAccounts {
	res := &UpdateFeesAndRewardsAccounts{}
	if inst.AccountMetaSlice[0] != nil {
		res.Whirlpool = inst.AccountMetaSlice[0].PublicKey
	}
	if inst.AccountMetaSlice[1] != nil {
		res.Position = inst.AccountMetaSlice[1].PublicKey
	}
	if inst.AccountMetaSlice[2] != nil {
		res.TickArrayLower = inst.AccountMetaSlice[2].PublicKey
	}
	if inst.AccountMetaSlice[3] != nil {
		res.TickArrayUpper = inst.AccountMetaSlice[3].PublicKey
	}
	return res
}
