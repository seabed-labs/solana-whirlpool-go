...
func (inst *SetRewardAuthority) GetSetRewardAuthorityAccounts() *SetRewardAuthorityAccounts {
	res := &SetRewardAuthorityAccounts{}
	if inst.AccountMetaSlice[0] != nil {
		res.Whirlpool = inst.AccountMetaSlice[0].PublicKey
	}
	if inst.AccountMetaSlice[1] != nil {
		res.RewardAuthority = inst.AccountMetaSlice[1].PublicKey
	}
	if inst.AccountMetaSlice[2] != nil {
		res.NewRewardAuthority = inst.AccountMetaSlice[2].PublicKey
	}
	return res
}
