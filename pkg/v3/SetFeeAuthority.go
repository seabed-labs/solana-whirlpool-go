...
type SetFeeAuthorityAccounts struct {
...
func (inst *SetFeeAuthority) GetSetFeeAuthorityAccounts() *SetFeeAuthorityAccounts {
	res := &SetFeeAuthorityAccounts{}
	if inst.AccountMetaSlice[0] != nil {
		res.WhirlpoolsConfig = inst.AccountMetaSlice[0].PublicKey
	}
	if inst.AccountMetaSlice[1] != nil {
		res.FeeAuthority = inst.AccountMetaSlice[1].PublicKey
	}
	if inst.AccountMetaSlice[2] != nil {
		res.NewFeeAuthority = inst.AccountMetaSlice[2].PublicKey
	}
	return res
}
