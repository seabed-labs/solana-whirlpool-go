...
type OpenPositionWithMetadataAccounts struct {
...
func (inst *OpenPositionWithMetadata) GetOpenPositionWithMetadataAccounts() *OpenPositionWithMetadataAccounts {
	res := &OpenPositionWithMetadataAccounts{}
	if inst.AccountMetaSlice[0] != nil {
		res.Funder = inst.AccountMetaSlice[0].PublicKey
	}
	if inst.AccountMetaSlice[1] != nil {
		res.Owner = inst.AccountMetaSlice[1].PublicKey
	}
	if inst.AccountMetaSlice[2] != nil {
		res.Position = inst.AccountMetaSlice[2].PublicKey
	}
	if inst.AccountMetaSlice[3] != nil {
		res.PositionMint = inst.AccountMetaSlice[3].PublicKey
	}
	if inst.AccountMetaSlice[4] != nil {
		res.PositionMetadataAccount = inst.AccountMetaSlice[4].PublicKey
	}
	if inst.AccountMetaSlice[5] != nil {
		res.PositionTokenAccount = inst.AccountMetaSlice[5].PublicKey
	}
	if inst.AccountMetaSlice[6] != nil {
		res.Whirlpool = inst.AccountMetaSlice[6].PublicKey
	}
	if inst.AccountMetaSlice[7] != nil {
		res.TokenProgram = inst.AccountMetaSlice[7].PublicKey
	}
	if inst.AccountMetaSlice[8] != nil {
		res.SystemProgram = inst.AccountMetaSlice[8].PublicKey
	}
	if inst.AccountMetaSlice[9] != nil {
		res.Rent = inst.AccountMetaSlice[9].PublicKey
	}
	if inst.AccountMetaSlice[10] != nil {
		res.AssociatedTokenProgram = inst.AccountMetaSlice[10].PublicKey
	}
	if inst.AccountMetaSlice[11] != nil {
		res.MetadataProgram = inst.AccountMetaSlice[11].PublicKey
	}
	if inst.AccountMetaSlice[12] != nil {
		res.MetadataUpdateAuth = inst.AccountMetaSlice[12].PublicKey
	}
	return res
}
