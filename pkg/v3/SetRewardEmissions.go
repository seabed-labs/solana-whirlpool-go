...
func (inst *SetRewardEmissions) GetSetRewardEmissionsAccounts() *SetRewardEmissionsAccounts {
	res := &SetRewardEmissionsAccounts{}
	...
	if inst.AccountMetaSlice[2] != nil {
		res.RewardVault = inst.AccountMetaSlice[2].PublicKey
	}
	return res
}
