...
func (inst *CollectProtocolFees) GetCollectProtocolFeesAccounts() *CollectProtocolFeesAccounts {
	res := &CollectProtocolFeesAccounts{}
	...
	if inst.AccountMetaSlice[2] != nil {
		res.CollectProtocolFeesAuthority = inst.AccountMetaSlice[2].PublicKey
	}
	if inst.AccountMetaSlice[3] != nil {
		res.TokenVaultA = inst.AccountMetaSlice[3].PublicKey
	}
	if inst.AccountMetaSlice[4] != nil {
		res.TokenVaultB = inst.AccountMetaSlice[4].PublicKey
	}
	if inst.AccountMetaSlice[5] != nil {
		res.TokenDestinationA = inst.AccountMetaSlice[5].PublicKey
	}
	if inst.AccountMetaSlice[6] != nil {
		res.TokenDestinationB = inst.AccountMetaSlice[6].PublicKey
	}
