...
func (inst *SetRewardAuthorityBySuperAuthority) GetSetRewardAuthorityBySuperAuthorityAccounts() *SetRewardAuthorityBySuperAuthorityAccounts {
	res := &SetRewardAuthorityBySuperAuthorityAccounts{}
	if inst.AccountMetaSlice[0] != nil {
		res.WhirlpoolsConfig = inst.AccountMetaSlice[0].PublicKey
	}
	if inst.AccountMetaSlice[1] != nil {
		res.Whirlpool = inst.AccountMetaSlice[1].PublicKey
	}
	if inst.AccountMetaSlice[2] != nil {
		res.RewardEmissionsSuperAuthority = inst.AccountMetaSlice[2].PublicKey
	}
	if inst.AccountMetaSlice[3] != nil {
		res.NewRewardAuthority = inst.AccountMetaSlice[3].PublicKey
	}
	return res
}
