...
func (inst *CollectReward) GetCollectRewardAccounts() *CollectRewardAccounts {
	res := &CollectRewardAccounts{}
	if inst.AccountMetaSlice[0] != nil {
		res.Whirlpool = inst.AccountMetaSlice[0].PublicKey
	}
	if inst.AccountMetaSlice[1] != nil {
		res.PositionAuthority = inst.AccountMetaSlice[1].PublicKey
	}
	if inst.AccountMetaSlice[2] != nil {
		res.Position = inst.AccountMetaSlice[2].PublicKey
	}
	if inst.AccountMetaSlice[3] != nil {
		res.PositionTokenAccount = inst.AccountMetaSlice[3].PublicKey
	}
	if inst.AccountMetaSlice[4] != nil {
		res.RewardOwnerAccount = inst.AccountMetaSlice[4].PublicKey
	}
	if inst.AccountMetaSlice[5] != nil {
		res.RewardVault = inst.AccountMetaSlice[5].PublicKey
	}
