...
func (inst *OpenPosition) GetOpenPositionAccounts() *OpenPositionAccounts {
	res := &OpenPositionAccounts{}
	...
	if inst.AccountMetaSlice[5] != nil {
		res.Whirlpool = inst.AccountMetaSlice[5].PublicKey
	}
	if inst.AccountMetaSlice[6] != nil {
		res.TokenProgram = inst.AccountMetaSlice[6].PublicKey
	}
	if inst.AccountMetaSlice[7] != nil {
		res.SystemProgram = inst.AccountMetaSlice[7].PublicKey
	}
	if inst.AccountMetaSlice[8] != nil {
		res.Rent = inst.AccountMetaSlice[8].PublicKey
	}
