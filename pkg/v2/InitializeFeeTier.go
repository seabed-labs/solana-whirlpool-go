...
func (inst *InitializeFeeTier) GetInitializeFeeTierAccounts() *InitializeFeeTierAccounts {
	res := &InitializeFeeTierAccounts{}
	if inst.AccountMetaSlice[0] != nil {
		res.Config = inst.AccountMetaSlice[0].PublicKey
	}
	if inst.AccountMetaSlice[1] != nil {
		res.FeeTier = inst.AccountMetaSlice[1].PublicKey
	}
	if inst.AccountMetaSlice[2] != nil {
		res.Funder = inst.AccountMetaSlice[2].PublicKey
	}
	if inst.AccountMetaSlice[3] != nil {
		res.FeeAuthority = inst.AccountMetaSlice[3].PublicKey
	}
	if inst.AccountMetaSlice[4] != nil {
		res.SystemProgram = inst.AccountMetaSlice[4].PublicKey
	}
	return res
}
