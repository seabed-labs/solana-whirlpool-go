...
type SetRewardEmissionsSuperAuthorityAccounts struct {
	WhirlpoolsConfig                 ag_solanago.PublicKey
	RewardEmissionsSuperAuthority    ag_solanago.PublicKey
	NewRewardEmissionsSuperAuthority ag_solanago.PublicKey
}
...
func (inst *SetRewardEmissionsSuperAuthority) GetSetRewardEmissionsSuperAuthorityAccounts() *SetRewardEmissionsSuperAuthorityAccounts {
	res := &SetRewardEmissionsSuperAuthorityAccounts{}
	if inst.AccountMetaSlice[0] != nil {
		res.WhirlpoolsConfig = inst.AccountMetaSlice[0].PublicKey
	}
	if inst.AccountMetaSlice[1] != nil {
		res.RewardEmissionsSuperAuthority = inst.AccountMetaSlice[1].PublicKey
	}
	if inst.AccountMetaSlice[2] != nil {
		res.NewRewardEmissionsSuperAuthority = inst.AccountMetaSlice[2].PublicKey
	}
	return res
}
