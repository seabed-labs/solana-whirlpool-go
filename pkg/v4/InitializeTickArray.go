...
func (inst *InitializeTickArray) GetInitializeTickArrayAccounts() *InitializeTickArrayAccounts {
	res := &InitializeTickArrayAccounts{}
	...
	if inst.AccountMetaSlice[2] != nil {
		res.TickArray = inst.AccountMetaSlice[2].PublicKey
	}
