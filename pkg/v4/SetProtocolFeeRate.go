...
type SetProtocolFeeRateAccounts struct {
...
func (inst *SetProtocolFeeRate) GetSetProtocolFeeRateAccounts() *SetProtocolFeeRateAccounts {
	res := &SetProtocolFeeRateAccounts{}
