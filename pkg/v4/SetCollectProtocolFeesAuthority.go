...
type SetCollectProtocolFeesAuthorityAccounts struct {
	WhirlpoolsConfig                ag_solanago.PublicKey
	CollectProtocolFeesAuthority    ag_solanago.PublicKey
	NewCollectProtocolFeesAuthority ag_solanago.PublicKey
}
...
func (inst *SetCollectProtocolFeesAuthority) GetSetCollectProtocolFeesAuthorityAccounts() *SetCollectProtocolFeesAuthorityAccounts {
	res := &SetCollectProtocolFeesAuthorityAccounts{}
	if inst.AccountMetaSlice[0] != nil {
		res.WhirlpoolsConfig = inst.AccountMetaSlice[0].PublicKey
	}
	if inst.AccountMetaSlice[1] != nil {
		res.CollectProtocolFeesAuthority = inst.AccountMetaSlice[1].PublicKey
	}
	if inst.AccountMetaSlice[2] != nil {
		res.NewCollectProtocolFeesAuthority = inst.AccountMetaSlice[2].PublicKey
	}
	return res
}
