...
func (inst *CollectFees) GetCollectFeesAccounts() *CollectFeesAccounts {
	res := &CollectFeesAccounts{}
	...
	if inst.AccountMetaSlice[4] != nil {
		res.TokenOwnerAccountA = inst.AccountMetaSlice[4].PublicKey
	}
	...
	if inst.AccountMetaSlice[7] != nil {
		res.TokenVaultB = inst.AccountMetaSlice[7].PublicKey
	}
