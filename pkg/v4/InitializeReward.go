...
func (inst *InitializeReward) GetInitializeRewardAccounts() *InitializeRewardAccounts {
	res := &InitializeRewardAccounts{}
	if inst.AccountMetaSlice[0] != nil {
		res.RewardAuthority = inst.AccountMetaSlice[0].PublicKey
	}
	if inst.AccountMetaSlice[1] != nil {
		res.Funder = inst.AccountMetaSlice[1].PublicKey
	}
	if inst.AccountMetaSlice[2] != nil {
		res.Whirlpool = inst.AccountMetaSlice[2].PublicKey
	}
	if inst.AccountMetaSlice[3] != nil {
		res.RewardMint = inst.AccountMetaSlice[3].PublicKey
	}
	if inst.AccountMetaSlice[4] != nil {
		res.RewardVault = inst.AccountMetaSlice[4].PublicKey
	}
	if inst.AccountMetaSlice[5] != nil {
		res.TokenProgram = inst.AccountMetaSlice[5].PublicKey
	}
	if inst.AccountMetaSlice[6] != nil {
		res.SystemProgram = inst.AccountMetaSlice[6].PublicKey
	}
	if inst.AccountMetaSlice[7] != nil {
		res.Rent = inst.AccountMetaSlice[7].PublicKey
	}
	return res
}
