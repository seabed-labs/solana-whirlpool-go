...
type SetDefaultProtocolFeeRateAccounts struct {
...
func (inst *SetDefaultProtocolFeeRate) GetSetDefaultProtocolFeeRateAccounts() *SetDefaultProtocolFeeRateAccounts {
	res := &SetDefaultProtocolFeeRateAccounts{}
