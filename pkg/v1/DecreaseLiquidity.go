...
type DecreaseLiquidityAccounts struct {
...
func (inst *DecreaseLiquidity) GetDecreaseLiquidityAccounts() *DecreaseLiquidityAccounts {
	res := &DecreaseLiquidityAccounts{}
	if inst.AccountMetaSlice[0] != nil {
		res.Whirlpool = inst.AccountMetaSlice[0].PublicKey
	}
	if inst.AccountMetaSlice[1] != nil {
		res.TokenProgram = inst.AccountMetaSlice[1].PublicKey
	}
	if inst.AccountMetaSlice[2] != nil {
		res.PositionAuthority = inst.AccountMetaSlice[2].PublicKey
	}
	if inst.AccountMetaSlice[3] != nil {
		res.Position = inst.AccountMetaSlice[3].PublicKey
	}
	if inst.AccountMetaSlice[4] != nil {
		res.PositionTokenAccount = inst.AccountMetaSlice[4].PublicKey
	}
	if inst.AccountMetaSlice[5] != nil {
		res.TokenOwnerAccountA = inst.AccountMetaSlice[5].PublicKey
	}
	if inst.AccountMetaSlice[6] != nil {
		res.TokenOwnerAccountB = inst.AccountMetaSlice[6].PublicKey
	}
	if inst.AccountMetaSlice[7] != nil {
		res.TokenVaultA = inst.AccountMetaSlice[7].PublicKey
	}
	if inst.AccountMetaSlice[8] != nil {
		res.TokenVaultB = inst.AccountMetaSlice[8].PublicKey
	}
	if inst.AccountMetaSlice[9] != nil {
		res.TickArrayLower = inst.AccountMetaSlice[9].PublicKey
	}
	if inst.AccountMetaSlice[10] != nil {
		res.TickArrayUpper = inst.AccountMetaSlice[10].PublicKey
	}
	return res
}
